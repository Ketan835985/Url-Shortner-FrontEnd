...
export default function UrlShortner() {
    ...
    const handelOnClick = async (e) => {
        ...
        if (e.target.value === "copy") {
            ...
            navigator.clipboard.writeText(JSON.parse(formData.shortUrl))
        }
    }
    return (
        <>
            ...
            <button type='copy' onClick={handelOnClick} value='copy'><span>
                <svg
            ...
            <hr />
            <button className='btn' type="redirect" onClick={handelOnClick} value="redirect">
                <svg
                    height={24}
                    width={24}
                    fill="#FFFFFF"
